...
- **GHCR pull secret** — image pull credential for the private frontend
  image. Placed manually in GSM once under `shared/ghcr-pull-secret`
  (cannot be auto-generated; per assignment, manual one-time placement of
  such secrets is acceptable).
